...
export const coreReferenceTopics: CoreReferenceTopic[] = [
  ...
  {
    patternId: 'dynamic-array', lessonId: 's01-l01', category: 'data-structures',
    aliases: ['dynamic array', 'vector', 'std::vector', 'python list', 'динамический массив'],
    complexity: [
  ...
  },
  {
    ...
    complexity: ['Чтение вершины и pop с конца — O(1); push в стек поверх динамического массива амортизированно O(1), отдельное расширение — O(n); память O(n).'],
