---
{
  ...
  "learningBlocks": [
    {
      "id": "unfinished-work-stack",
      "type": "mental-model",
      "placement": "before-content",
      "title": "Стек хранит только незавершённую работу",
      "body": "Для скобок не требуется помнить всю строку: важны открывающие конструкции, которые ещё ждут пару.",
      "items": [
        { "label": "Открывающая скобка", "detail": "Добавляет новое незавершённое ожидание на вершину." },
        { "label": "Закрывающая скобка", "detail": "Должна совпасть именно с последним ожиданием." },
        { "label": "Пустой стек в конце", "detail": "Все открытые конструкции получили пару." }
      ]
    }
  ]
}
