---
{
  ...
  "learningBlocks": [
    {
      "id": "linear-stack-accounting",
      "type": "complexity",
      "placement": "after-content",
      "title": "Почему вложенный while не делает алгоритм квадратичным",
      "body": "Одна итерация может снять много индексов, но один и тот же индекс нельзя снять дважды.",
      "steps": [
        { "label": "Добавление", "detail": "Каждый из n индексов попадает в стек ровно один раз." },
        { "label": "Удаление", "detail": "После pop индекс навсегда покидает стек, поэтому удалений не больше n." },
        { "label": "Остальная работа", "detail": "Сравнения и запись ответа возле каждой операции занимают O(1)." }
      ],
      "result": "Не более n push + n pop → O(n) времени и O(n) памяти."
    }
  ]
}
---
