---
{
  ...
  "summary": "Алгоритм Кана удаляет только вершины без оставшихся зависимостей; неполный результат обнаруживает цикл.",
  "outcomes": [
...
## Как выстроить задачи после всех предварительных условий?

Упорядочить задачи ориентированного графа так, чтобы каждое предварительное условие шло раньше зависимой задачи.
...
Нужно выполнить курсы, сборки или задачи после всех предварительных условий; граф направленный.
