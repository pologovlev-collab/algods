---
{
  ...
  "learningBlocks": [
    {
      "id": "choose-adjacency-list",
      "type": "choose",
      "placement": "after-content",
      "title": "Список смежности — не универсальный ответ",
      "body": "Представление выбирают по плотности графа и операциям, которые алгоритм выполняет чаще всего.",
      "useWhen": [
